...
Darwin)
    ...
    ;;
MINGW64_NT*)
    export JAVA_HOME='/c/PROGRA~1/Unity/Hub/Editor/6000.0.59f2/Editor/Data/PlaybackEngines/AndroidPlayer/OpenJDK'
    export ANDROID_SDK_ROOT='/c/PROGRA~1/Unity/Hub/Editor/6000.0.59f2/Editor/Data/PlaybackEngines/AndroidPlayer/SDK'
    export PATH=$ANDROID_SDK_ROOT/platform-tools:$ANDROID_SDK_ROOT/tools:$ANDROID_SDK_ROOT/tools/bin:$JAVA_HOME/bin:$PATH
    ;;
esac
...
then
    ...
    echo 'From Unity Hub, please install 6000.0.59f2 with the android module.'
    exit 1
fi
